 ...
 */
export default interface DateValidator<T> {
    /**
     * Checks whether a date is after the given date.
     *
     * @param date Date to check against.
     */
    after(date: Date): ValidatorSyntax<DateValidator<T>, T, Date>
     ...
     * @param date Date to check against.
     */
    before(date: Date): ValidatorSyntax<DateValidator<T>, T, Date>
    ...
    between(
        pastDate: Date,
        futureDate: Date,
    ): ValidatorSyntax<DateValidator<T>, T, Date>
     ...
     * @param date Date to check against.
     */
    same(date: Date): ValidatorSyntax<DateValidator<T>, T, Date>
}
